...
namespace PharmacyManagementSystem
{
    public partial class Medicines : Form
    {
        ...
        string connectionString = "Data Source=.;Initial Catalog=20190305012;Integrated Security=True";
        ...
        {
            // TODO: Bu kod satırı '_20190305012DataSet.Manufacturer' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.manufacturerTableAdapter.Fill(this._20190305012DataSet.Manufacturer);
            // TODO: Bu kod satırı '_20190305012DataSet.MedicationTypes' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.medicationTypesTableAdapter.Fill(this._20190305012DataSet.MedicationTypes);
            // TODO: Bu kod satırı '_20190305012DataSet.MedicationTypes' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.medicationTypesTableAdapter.Fill(this._20190305012DataSet.MedicationTypes);
